...
export function InvestigationDashboard() {
  ...
  return (
    <div className="space-y-6 text-slate-800 font-sans max-w-7xl mx-auto">
      ...
      <div className="bg-white border border-slate-200/90 rounded-3xl p-6 md:p-7 shadow-xs flex flex-col md:flex-row md:items-center justify-between gap-5">
        <div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        <div className="bg-gradient-to-br from-blue-50/90 via-sky-50/50 to-white border border-blue-100 p-5 rounded-2xl shadow-xs space-y-1">
          ...
          <div className="text-[11px] text-blue-700/80 font-medium">Under active inquiry</div>
        </div>

        <div className="bg-gradient-to-br from-rose-50/90 via-pink-50/50 to-white border border-rose-100 p-5 rounded-2xl shadow-xs space-y-1">
          ...
          <div className="text-[11px] text-rose-700/80 font-medium">Requires immediate action</div>
        </div>

        <div className="bg-gradient-to-br from-amber-50/90 via-yellow-50/50 to-white border border-amber-100 p-5 rounded-2xl shadow-xs space-y-1">
          ...
          <div className="text-[11px] text-amber-700/80 font-medium">AFIS record linked</div>
        </div>

        <div className="bg-gradient-to-br from-emerald-50/90 via-teal-50/50 to-white border border-emerald-100 p-5 rounded-2xl shadow-xs space-y-1">
          ...
          <div className="text-[11px] text-emerald-700/80 font-medium">Digitized repository</div>
        </div>
      </div>
      ...
      <div className="bg-white border border-slate-200/90 p-4 rounded-2xl shadow-xs space-y-3">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-3">
          ...
          <div className="flex items-center space-x-2 text-xs">
            ...
            <select 
              ...
              className="bg-slate-50 border border-slate-200 rounded-full px-3 py-1.5 font-semibold text-slate-800 text-xs focus:outline-none cursor-pointer"
            >
        ...
        <div className="relative">
          ...
          <input 
            ...
            className="w-full bg-slate-50 border border-slate-200 text-slate-900 text-xs rounded-full pl-10 pr-4 py-2 focus:outline-none focus:bg-white focus:border-blue-500 placeholder:text-slate-400 transition-colors"
          />
        </div>
      </div>
      ...
      {activeCaseCategoryTab === 'recent' && (
        <div className="bg-white border border-slate-200/90 rounded-3xl shadow-xs overflow-hidden">
          <div className="px-6 py-4 border-b border-slate-100 flex items-center justify-between">
            ...
            <span className="text-xs text-slate-500">{filteredCases.length} assigned records</span>
          </div>
              ...
              return (
                ...
                >
                  <div className="flex items-start space-x-4 min-w-0">
                    ...
                    <div className={`w-12 h-12 rounded-2xl flex flex-col items-center justify-center shrink-0 mt-0.5 border transition-all group-hover:scale-105 ${pStyle.block}`}>
                    ...
                    <div className="space-y-1.5 min-w-0 pt-0.5">
                      <div className="flex flex-wrap items-center gap-2">
                        <span className="font-extrabold text-slate-900 text-sm md:text-base group-hover:text-blue-600 transition-colors tracking-tight">
                          {c.id}: {c.title}
                        </span>

                        <span className={`inline-flex items-center px-2 py-0.5 rounded-full text-[10px] font-bold uppercase tracking-wider border ${pStyle.bg} ${pStyle.text} ${pStyle.border}`}>
                          {c.priority} PRIORITY
                        </span>

                        <span className={`inline-flex items-center px-2 py-0.5 rounded-full text-[10px] font-bold uppercase tracking-wider border ${sStyle.bg} ${sStyle.text} ${sStyle.border}`}>
                          {c.status}
                        </span>
                      </div>
                      ...
                      <div className="flex flex-wrap items-center gap-x-4 gap-y-2 pt-1 text-xs text-slate-500">
                        <div className="flex items-center space-x-1.5">
                          ...
                          <span><strong className="text-slate-700 font-semibold">{c.category}</strong></span>
                        </div>
                        <div className="flex items-center space-x-1.5">
                          <MapPin className="w-3.5 h-3.5 text-slate-400" />
                          <span><strong className="text-slate-700 font-semibold">{c.district}</strong></span>
                        </div>
                        <div className="flex items-center space-x-1.5">
                          <UserCheck className="w-3.5 h-3.5 text-slate-400" />
                          <span>IO: <strong className="text-slate-700 font-semibold">{c.assignedTo}</strong></span>
                        </div>
                        <div className="flex items-center space-x-1.5">
                          <Clock className="w-3.5 h-3.5 text-slate-400" />
                          <span>Upd: <strong className="text-slate-700 font-semibold">{c.lastUpdated}</strong></span>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center space-x-2.5 shrink-0 self-end md:self-center" onClick={(e) => e.stopPropagation()}>
                    ...
                    <button 
                      ...
                      className="px-3 py-1.5 bg-blue-600 hover:bg-blue-700 text-white rounded-xl text-xs font-semibold shadow-sm shadow-blue-500/20 transition-all flex items-center space-x-1"
                    >
                      <span>Open File</span>
        ...
        <div className="bg-white border border-slate-200/90 rounded-3xl p-6 space-y-6 shadow-xs">
          <div className="flex items-center justify-between border-b border-slate-100 pb-3">
            <div>
              ...
              <p className="text-xs text-slate-500">2,000 closed and historical police records available for precedent lookup</p>
            </div>
          </div>

          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
            {mockOldCasesSummary.breakdown.map(cat => (
              <div key={cat.category} className="p-4 bg-slate-50 border border-slate-200/80 rounded-2xl space-y-1">
                <div className="text-xs text-slate-500 font-medium">{cat.category}</div>
          ...
          <div className="flex gap-2 pt-2">
            <input 
              ...
              className="flex-1 bg-slate-50 border border-slate-200 rounded-full px-4 py-2 text-xs text-slate-900 focus:outline-none focus:border-blue-500"
            />
            <button 
      ...
      <div className="bg-white border border-slate-200/90 rounded-3xl p-6 shadow-xs space-y-4">
        <div className="border-b border-slate-100 pb-3">
          ...
          <p className="text-xs text-slate-500">Quick access to specialized analytical workspaces</p>
        </div>

        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3">
          <div 
            onClick={() => navigate('analysis', { tab: 'evidence' })} 
            className="p-4 bg-slate-50 hover:bg-slate-100 border border-slate-200 rounded-2xl text-center cursor-pointer transition-colors space-y-1.5 group active:scale-[0.98]"
          >
            <FolderGit2 className="w-5 h-5 text-slate-700 mx-auto group-hover:text-blue-600 transition-colors" />
            <div className="font-semibold text-slate-900 text-xs">Evidence Vault</div>
            <div className="text-[11px] text-slate-500">CDR, Bank & ANPR</div>
          </div>
          ...
          <div 
            ...
            className="p-4 bg-slate-50 hover:bg-slate-100 border border-slate-200 rounded-2xl text-center cursor-pointer transition-colors space-y-1.5 group active:scale-[0.98]"
          >
            <Network className="w-5 h-5 text-slate-700 mx-auto group-hover:text-blue-600 transition-colors" />
            <div className="font-semibold text-slate-900 text-xs">Network Graph</div>
            <div className="text-[11px] text-slate-500">Entity Topology</div>
          </div>
          ...
          <div 
            ...
            className="p-4 bg-slate-50 hover:bg-slate-100 border border-slate-200 rounded-2xl text-center cursor-pointer transition-colors space-y-1.5 group active:scale-[0.98]"
          >
            <Clock className="w-5 h-5 text-slate-700 mx-auto group-hover:text-blue-600 transition-colors" />
            <div className="font-semibold text-slate-900 text-xs">Timeline Analysis</div>
            <div className="text-[11px] text-slate-500">Chronology Matrix</div>
          </div>
          ...
          <div 
            ...
            className="p-4 bg-slate-50 hover:bg-slate-100 border border-slate-200 rounded-2xl text-center cursor-pointer transition-colors space-y-1.5 group active:scale-[0.98]"
          >
            <UserCheck className="w-5 h-5 text-slate-700 mx-auto group-hover:text-blue-600 transition-colors" />
            <div className="font-semibold text-slate-900 text-xs">Suspect Dossiers</div>
            <div className="text-[11px] text-slate-500">AFIS & Biometrics</div>
          </div>
          ...
          <div 
            ...
            className="p-4 bg-slate-50 hover:bg-slate-100 border border-slate-200 rounded-2xl text-center cursor-pointer transition-colors space-y-1.5 group active:scale-[0.98]"
          >
            <BarChart2 className="w-5 h-5 text-slate-700 mx-auto group-hover:text-blue-600 transition-colors" />
            <div className="font-semibold text-slate-900 text-xs">Incident Map</div>
            <div className="text-[11px] text-slate-500">Telemetry Feed</div>
          </div>
          ...
          <div 
            ...
            className="p-4 bg-slate-50 hover:bg-slate-100 border border-slate-200 rounded-2xl text-center cursor-pointer transition-colors space-y-1.5 group active:scale-[0.98]"
          >
            <LayoutTemplate className="w-5 h-5 text-slate-700 mx-auto group-hover:text-blue-600 transition-colors" />
            <div className="font-semibold text-slate-900 text-xs">Corkboard Studio</div>
            <div className="text-[11px] text-slate-500">Tactical Canvas</div>
          </div>
        </div>
      </div>
    </div>
