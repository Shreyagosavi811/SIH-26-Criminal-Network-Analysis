      ...
      case 'settings':
        return (
          <div className="max-w-4xl mx-auto space-y-6 text-slate-800 font-sans">
            {/* Header */}
            <div className="bg-white rounded-xl p-6 shadow-md shadow-slate-200/50 space-y-2">
              <div className="flex items-center space-x-3.5">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-500 mt-0.5">Manage API integrations with police FIR databases, CDR telemetry, ANPR cameras, and FIU alerts.</p>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {/* FIR DB */}
              <div className="bg-white p-5 rounded-lg shadow-md shadow-slate-200/50 flex flex-col justify-between space-y-4 hover:shadow-lg transition-all">
                <div className="flex items-start justify-between">
                  <div className="flex items-center space-x-3.5">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-slate-500 font-medium mt-0.5">CCTNS State Police Gateway</p>
                    </div>
                  </div>
                </div>
                <div className="flex items-center justify-between pt-3.5 border-t border-slate-100">
                  <span className="text-xs font-mono text-slate-400 font-medium">Last sync: 2 mins ago</span>
                  <div className="flex items-center space-x-1.5 px-2 py-0.5 rounded bg-emerald-50 text-emerald-700 border border-emerald-100 text-xs font-medium">
                ...
                <div className="flex items-start justify-between">
                  <div className="flex items-center space-x-3.5">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-slate-500 font-medium mt-0.5">Telecom Provider Intercepts</p>
                    </div>
                  </div>
                </div>
                <div className="flex items-center justify-between pt-3.5 border-t border-slate-100">
                  <span className="text-xs font-mono text-slate-400 font-medium">Stream: Encrypted</span>
                  <div className="flex items-center space-x-1.5 px-2 py-0.5 rounded bg-emerald-50 text-emerald-700 border border-emerald-100 text-xs font-medium">
                    <CheckCircle2 className="w-3 h-3" />
                    <span>ACTIVE</span>
                  </div>
                ...
                <div className="flex items-start justify-between">
                  <div className="flex items-center space-x-3.5">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-slate-500 font-medium mt-0.5">Financial Intelligence Unit</p>
                    </div>
                  </div>
                </div>
                <div className="flex items-center justify-between pt-3.5 border-t border-slate-100">
                  <span className="text-xs font-mono text-slate-400 font-medium">Status: Polling</span>
                  <div className="flex items-center space-x-1.5 px-2 py-0.5 rounded bg-emerald-50 text-emerald-700 border border-emerald-100 text-xs font-medium">
                    <CheckCircle2 className="w-3 h-3" />
                    <span>ONLINE</span>
                  </div>
