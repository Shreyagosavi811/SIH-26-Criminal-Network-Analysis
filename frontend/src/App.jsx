        ...
        return (
          <div className="max-w-4xl mx-auto space-y-6 text-slate-800 font-sans">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {/* FIR DB */}
              <div className="bg-white border border-slate-200/90 rounded-2xl p-5 shadow-xs flex flex-col justify-between space-y-4 hover:border-slate-300 transition-colors">
                <div className="flex items-start justify-between">
                  <div className="flex items-center space-x-3.5">
                    ...
                    <div>
                      <h3 className="font-bold text-slate-900 text-sm">FIR Database Synchronization</h3>
                      <p className="text-[10px] text-slate-500 uppercase tracking-wider mt-0.5">CCTNS State Police Gateway</p>
                    </div>
                  </div>
                </div>
                <div className="flex items-center justify-between pt-3.5 border-t border-slate-100">
                  <span className="text-[11px] font-mono text-slate-400 font-medium">Last sync: 2 mins ago</span>
                  <div className="flex items-center space-x-1.5 px-2.5 py-1 rounded-md bg-emerald-50 text-emerald-700 border border-emerald-200 text-[10px] font-bold">
              ...
              <div className="bg-white border border-slate-200/90 rounded-2xl p-5 shadow-xs flex flex-col justify-between space-y-4 hover:border-slate-300 transition-colors">
                <div className="flex items-start justify-between">
                  <div className="flex items-center space-x-3.5">
                    ...
                    <div>
                      <h3 className="font-bold text-slate-900 text-sm">CDR Telemetry Gateway</h3>
                      <p className="text-[10px] text-slate-500 uppercase tracking-wider mt-0.5">Telecom Provider Intercepts</p>
                    </div>
                  </div>
                </div>
                <div className="flex items-center justify-between pt-3.5 border-t border-slate-100">
              ...
              <div className="bg-white border border-slate-200/90 rounded-2xl p-5 shadow-xs flex flex-col justify-between space-y-4 hover:border-slate-300 transition-colors">
                <div className="flex items-start justify-between">
                  <div className="flex items-center space-x-3.5">
                    ...
                    <div>
                      <h3 className="font-bold text-slate-900 text-sm">FIU Financial Alert Pipeline</h3>
                      <p className="text-[10px] text-slate-500 uppercase tracking-wider mt-0.5">Financial Intelligence Unit</p>
                    </div>
                  </div>
                </div>
                <div className="flex items-center justify-between pt-3.5 border-t border-slate-100">
